...
public class ReservaDTO {
    ...
    private List<HistoricoAlteracaoEstadoDTO> historicoAlteracaoEstado;
    ...
    public List<HistoricoAlteracaoEstadoDTO> getHistoricoAlteracaoEstado() { return historicoAlteracaoEstado; }
    public void setHistoricoAlteracaoEstado(List<HistoricoAlteracaoEstadoDTO> historicoAlteracaoEstado) { 
